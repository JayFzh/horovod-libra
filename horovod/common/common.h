...
#define HOROVOD_STREAM_ASSIGNMENT "HOROVOD_STREAM_ASSIGNMENT"
#define HOROVOD_PARALLEL_THREADNUM "HOROVOD_PARALLEL_THREADNUM"
#define HOROVOD_PARALLEL_OR_NOT "HOROVOD_PARALLEL_OR_NOT"
