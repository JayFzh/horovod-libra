...
public:
  ...
  // lyz - alloc
  int block_num; //number of blocks(channels) to allocate to the corresponding allreduce kernel
  int thread_num; //number of threads for each block
...
public:
  ...
  // lyz - alloc
  int32_t block_num; //number of blocks(channels) to allocate to the corresponding allreduce kernel
  int32_t thread_num; //number of threads for each block
