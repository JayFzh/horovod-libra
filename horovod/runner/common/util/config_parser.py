...
HOROVOD_STREAM_ASSIGNMENT = 'HOROVOD_STREAM_ASSIGNMENT'
...
def set_args_from_config(args, config, override_args):
    ...
    if library_options:
        ...
        # fzh param
        _set_arg_from_config(args, 'stream_assignment', override_args, library_options)
...
def set_env_from_args(env, args):
    ...
    _add_arg_to_env(env, HOROVOD_STREAM_ASSIGNMENT, args.stream_assignment)
